...
class _LoginPageState extends State<LoginPage> {
  ...
  void _showOverlay({required BuildContext dialogContext, bool show = true}) {
    show
        ? showDialog(
  ...
  String? _errorText({required TextEditingController controller}) {
    ...
    if (text.length < 6) {
      return 'Không được nhỏ hơn 6 ký tự';
    }
